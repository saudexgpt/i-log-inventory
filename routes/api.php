...
$router->group(['middleware' => 'auth:api'], function () use ($router) {
    $router->get('fetch-subscription', 'SubscriptionsController@fetchSubscription');
    $router->get('need-to-subscribe', 'SubscriptionsController@needToSubscribe');
    $router->post('subscribe/pay-via-card', 'SubscriptionsController@subscriptionPayment');
